...
def gen_markup_for_voice():
        ...
        markup.add(InlineKeyboardButton('Транскрибировать аудио', callback_data='voice_transcribe'),
                   InlineKeyboardButton('Получить ответ', callback_data='voice_ans'),
...
def handle_voice(message):
    ...
    bot.send_message(message.chat.id, "Я получил твое сообщение! Что ты хочешь с ним сделать?", reply_markup=gen_markup_for_voice())
